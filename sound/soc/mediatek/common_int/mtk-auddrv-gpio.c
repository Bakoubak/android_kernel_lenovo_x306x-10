...
int AudDrv_GPIO_EXTAMP_Select(int bEnable, int mode)
{
	...
	if (bEnable == 1)
	{
		...
		{
			gpio_set_value(extamp_1,0); //  1
			udelay(1);
			gpio_set_value(extamp_1,1);

			gpio_set_value(extamp_1,0);  // 2
			udelay(1);
			gpio_set_value(extamp_1,1);

			gpio_set_value(extamp_1,0);  // 3
			udelay(1);
			gpio_set_value(extamp_1,1);

			gpio_set_value(extamp_1,0);  // 4
			udelay(1);
			gpio_set_value(extamp_1,1);

			gpio_set_value(extamp_1,0);  // 5
			udelay(1);
			gpio_set_value(extamp_1,1);

			gpio_set_value(extamp_1,0);  // 6
			udelay(1);
			gpio_set_value(extamp_1,1);

			gpio_set_value(extamp_1,0);  // 7
			udelay(1);
			gpio_set_value(extamp_1,1);

			gpio_set_value(extamp_1,0);  // 8
			udelay(1);
			gpio_set_value(extamp_1,1);

			gpio_set_value(extamp_1,0);  //9
			udelay(1);
			gpio_set_value(extamp_1,1);

			gpio_set_value(extamp_1,0); //  10
			udelay(1);
			gpio_set_value(extamp_1,1);
...
int AudDrv_GPIO_EXTAMP2_Select(int bEnable, int mode)
{
	...
	if (bEnable == 1)
	{
		...
		{
			gpio_set_value(extamp_2,0);  // 1
			udelay(1);
			gpio_set_value(extamp_2,1);

			gpio_set_value(extamp_2,0);  // 2
			udelay(1);
			gpio_set_value(extamp_2,1);

			gpio_set_value(extamp_2,0);  // 3
			udelay(1);
			gpio_set_value(extamp_2,1);


			gpio_set_value(extamp_2,0);  // 4
			udelay(1);
			gpio_set_value(extamp_2,1);

			gpio_set_value(extamp_2,0);  // 5
			udelay(1);
			gpio_set_value(extamp_2,1);

			gpio_set_value(extamp_2,0);   // 6
			udelay(1);
			gpio_set_value(extamp_2,1);


			gpio_set_value(extamp_2,0);  //7
			udelay(1);
			gpio_set_value(extamp_2,1);

			gpio_set_value(extamp_2,0);  // 8
			udelay(1);
			gpio_set_value(extamp_2,1);

			gpio_set_value(extamp_2,0);  // 9
			udelay(1);
			gpio_set_value(extamp_2,1);

			gpio_set_value(extamp_2,0);  // 10
			udelay(1);
			gpio_set_value(extamp_2,1);
		}
	}
